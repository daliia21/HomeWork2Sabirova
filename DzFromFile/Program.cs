...
decimal volumeAlkohol = (student1.alcoholVolume * student1.alcoholicBeverage.alcoholPercentage) / 100 + (student2.alcoholVolume * student2.alcoholicBeverage.alcoholPercentage) / 100 + (student3.alcoholVolume * student3.alcoholicBeverage.alcoholPercentage) / 100 + (student4.alcoholVolume * student4.alcoholicBeverage.alcoholPercentage) / 100 + (student5.alcoholVolume * student5.alcoholicBeverage.alcoholPercentage) / 100;
Console.WriteLine($"Общий объём алкоголя: {volumeAlkohol}");

Console.WriteLine($"{student1.firstName} {student2.lastName}: выпил {(student1.alcoholVolume / volume) * 100}% от общего количества, {(student1.alcoholicBeverage.alcoholPercentage * student1.alcoholVolume) / volumeAlkohol}% от общего количества спирта");
Console.WriteLine($"{student2.firstName} {student2.lastName}: выпил {(student2.alcoholVolume / volume) * 100}% от общего количества, {(student2.alcoholicBeverage.alcoholPercentage * student2.alcoholVolume) / volumeAlkohol}% от общего количества спирта");
Console.WriteLine($"{student3.firstName} {student3.lastName}: выпил {(student3.alcoholVolume / volume) * 100}% от общего количества, {(student3.alcoholicBeverage.alcoholPercentage * student3.alcoholVolume) / volumeAlkohol}% от общего количества спирта");
Console.WriteLine($"{student4.firstName} {student4.lastName}: выпил {(student4.alcoholVolume / volume) * 100}% от общего количества, {(student4.alcoholicBeverage.alcoholPercentage * student4.alcoholVolume) / volumeAlkohol}% от общего количества спирта");
Console.WriteLine($"{student5.firstName} {student5.lastName}: выпил {(student5.alcoholVolume / volume) * 100}% от общего количества, {(student5.alcoholicBeverage.alcoholPercentage * student5.alcoholVolume) / volumeAlkohol}% от общего количества спирта");
